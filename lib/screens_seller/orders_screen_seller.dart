...
class OrderScreenSeller extends StatefulWidget {
  const OrderScreenSeller({super.key});

  static const String id = 'order-screen-seller';

  @override
  State<OrderScreenSeller> createState() => _OrderScreenSellerState();
}

class _OrderScreenSellerState extends State<OrderScreenSeller> {
  ...
  Widget build(BuildContext context) {
    var orderProvider = Provider.of<OrderProviderSeller>(context);
    return Scaffold(
      appBar: AppBar(
