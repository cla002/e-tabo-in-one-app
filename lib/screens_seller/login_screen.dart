...
class _LoginScreenSellerState extends State<LoginScreenSeller> {
  ...
  late AuthProviderSeller _authData;
  bool _loading = false;

  @override
  Widget build(BuildContext context) {
    _authData = Provider.of<AuthProviderSeller>(context);
    return SafeArea(
      child: Scaffold(
        body: Form(
          key: _formKey,
                    ...
                    Row(
                      ...
                      children: [
                        InkWell(
                          onTap: () {
                            Navigator.pushNamed(
                                context, ResetPasswordScreenSeller.id);
                          },
                          child: const Text(
                            'Forgot Password?',
                            style: TextStyle(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            Navigator.pushNamed(
                                context, RegistrationScreenSeller.id);
                          },
                          child: const Text(
                            'Register',
          ...
          FirebaseFirestore.instance
            ...
            if (doc.exists) {
              ...
              if (accountVerified) {
                ...
                Navigator.pushReplacementNamed(context, WaitingScreenSeller.id);
              }
            } else {
