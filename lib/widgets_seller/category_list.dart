...
import 'package:buyers/services_seller/category_services.dart';
...
class _CategoryListState extends State<CategoryList> {
  final CategoryListServicesSeller _categoryServices =
      CategoryListServicesSeller();
  @override
      ...
      child: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder(
                stream: CategoryListServicesSeller().getCategoryList(),
