...
class AddEditCouponScreenSeller extends StatefulWidget {
  final DocumentSnapshot? document;
  static const String id = 'add-edit-screen';
  const AddEditCouponScreenSeller({super.key, required this.document});

  @override
  State<AddEditCouponScreenSeller> createState() =>
      _AddEditCouponScreenSellerState();
}

class _AddEditCouponScreenSellerState extends State<AddEditCouponScreenSeller> {
