...
import 'package:buyers/widgets_seller/category_list.dart';
import 'package:flutter/material.dart';
import 'package:flutter_easyloading/flutter_easyloading.dart';

class AddNewProductSeller extends StatefulWidget {
  static const String id = 'add-new-product-screen';

  const AddNewProductSeller({Key? key}) : super(key: key);

  @override
  State<AddNewProductSeller> createState() => _AddNewProductSellerState();
}

class _AddNewProductSellerState extends State<AddNewProductSeller> {
          ...
          leading: IconButton(
            ...
            onPressed: () {
              Navigator.of(context).pushReplacement(
                MaterialPageRoute(
                  builder: (context) => const ProductScreenSeller(),
                ),
              );
            },
          ),
