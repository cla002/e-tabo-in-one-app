...
import 'package:buyers/providers_seller/product_provider.dart';
import 'package:buyers/services_seller/firebase_services.dart';
import 'package:buyers/widgets_seller/vendor_banner_card.dart';
...
class BannerScreenSeller extends StatefulWidget {
  const BannerScreenSeller({super.key});

  static const String id = 'banner-screebn';

  @override
  State<BannerScreenSeller> createState() => _BannerScreenSellerState();
}

class _BannerScreenSellerState extends State<BannerScreenSeller> {
  final FirebaseServicesSeller _services = FirebaseServicesSeller();
  final ProductProviderSeller _provider = ProductProviderSeller();
  File? _image = null;
  String pickerError = '';
