...
import 'package:buyers/services_buyer/cart_services.dart';
import 'package:buyers/services_buyer/order_services.dart';
import 'package:buyers/services_buyer/user_services.dart';
...
class _BottomSheetWidgetState extends State<BottomSheetWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    var userDetails = Provider.of<MyAuthProviderBuyer>(context);
    userDetails.getUserDetails();

    return Consumer<CartProviderBuyer>(
  ...
  Future<void> _saveOrder(CartProviderBuyer cartProvider, payable) async {
