...
import 'package:buyers/widgets_buyer/cart/bottom_sheet_cart_buyer.dart';
import 'package:buyers/widgets_buyer/cart/cart_list.dart';
import 'package:buyers/widgets_buyer/cart/shop_details.dart';
                ...
                TextButton(
                    onPressed: () {
                      PersistentNavBarNavigator.pushNewScreenWithRouteSettings(
                        context,
                        settings:
                            const RouteSettings(arguments: MainScreenBuyer.id),
                        screen: const MainScreenBuyer(),
                        withNavBar: false,
