...
class ResetPasswordScreenSeller extends StatefulWidget {
  const ResetPasswordScreenSeller({super.key});
  static const String id = 'reset-password-screen';

  @override
  State<ResetPasswordScreenSeller> createState() =>
      _ResetPasswordScreenSellerState();
}

class _ResetPasswordScreenSellerState extends State<ResetPasswordScreenSeller> {
  ...
  Widget build(BuildContext context) {
    final _authData = Provider.of<AuthProviderSeller>(context);
    return Scaffold(
      body: Form(
        key: _formKey,
        child: Center(
